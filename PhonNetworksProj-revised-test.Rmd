...
{plot_smooth(INT.gamm.1_A, view="AOP", rug=F, col="lightblue",
              ylim = c(-2,3),
              xlim = c(12,30),
              main = "Figure 1",
              xlab = "Age (months)",
              ...
              hide.label = T)
plot_smooth(INT.gamm.1_T, view="AOP", rug=F, col="darkblue", add=T,
              ylim = c(-2,3),
              xlim = c(12,30),
...
{plot_smooth(EXT.gamm.1_A, view="AOP", rug=F, col="#FFCDD2",
              ylim = c(-1,0.5),
              xlim = c(12,30),
              main = "Figure 2",
              xlab = "Age (months)",
              ...
              hide.label = T)
plot_smooth(EXT.gamm.1_T, view="AOP", rug=F, col="darkred", add=T,
              ylim = c(-1,0.5),
              xlim = c(12,30),
              #main = "",
              xlab = "Age (months)",
...
The difference of the two smooths is shown in Figure \@ref(fig:difference-smooth-data-type). The red line indicates periods where the two trajectories differed significantly from one another - from ~15 months until the final time-point in the analysis. For clarity, the two smooths are visualised in Figure \@ref(fig:plotted-smooth-data-type) where the difference between the two trajectories is apparent.
