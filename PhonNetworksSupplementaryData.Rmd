...
```{r table-phon-dist-balloon, echo=FALSE, message=FALSE, warning=FALSE}
...
knitr::kable(phon.dist.table.balloon, "latex", booktabs=T, longtable=T, caption=cap, digits = 2, align="c",
  ...
  kable_styling(font_size = 9)  %>%
   add_header_above(c(" "=1, "Baby"=2, "Balloon"=2, " " =1))
```

```{r table-phon-dist-sky, echo=FALSE, message=FALSE, warning=FALSE}
...
knitr::kable(phon.dist.table.sky, "latex", booktabs=T, longtable=T, caption=cap, digits = 2, align="c",
      col.names=c("Word position", 
                  "Cons.", "Features", 
                  #"Cons.", "Features", "Sum sq. diffs", 
                  "Cons.", "Features", "Sum sq. diffs"),
  ...
  column_spec(6, width = "3cm") %>%
  kable_styling(font_size = 9)  %>%
   add_header_above(c(" "=1, "Baby"=2, "Sky"=2, " " =1))
```
...
kable(actual.thresholdstest, "latex", booktabs=T, caption=cap, longtable = T, digits=2, align="c",
...
kable(target.thresholdstest, "latex", booktabs=T, caption=cap, longtable = T, digits=2, align="c",
    col.names=c("Threshold", "Unconnected words", "Spearman's rho", 
                "Estimate", "p", "95% CI", 
                "Estimate", "p", "95% CI")) %>%
  #kable_styling(latex_options="scale_down") %>%
...
```{r Figure-AOP-deg-corr, echo=FALSE, fig.pos='H', message=FALSE, warning=FALSE, fig.cap=cap, fig.height = 7}
...
```{r by-speaker-data, echo=FALSE, fig.cap=cap, fig.height = 7}
